...
BEGIN { 
  ...
  b0=0.75; # bond length
  tn=128;  #total length of chain
  xx0=0.0; yy0=2.9949; zz0=0.0; # origin
  nx=2; nz=48; ny=1; # replication (quasi-hexagonal lattice in yz-plane)

  #box size xx > pp*n*2
  #n is no of humps, is also the base and top of the hump
  boxz=40; #controlled
  boxy=2; #has no control basically 
  boxx=40; #has no control basically
...
#printcount,tn; #count prints no of atoms in one hump
      } 
    }
  }
}
